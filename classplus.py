                 ...
                 try:
                    if len(df)>0:
                        with open(f"{filename}",'wt') as f:
                            f.write(df)
                        time.sleep(1)
                        await bot.send_document(ct2,filename,caption=f"**CourseName : `{bname}`\n\nFiles : `{files}` 📂  |  Videos : `{videos}` 🎬**")
                        os.remove(filename)
                    else:
...
"""
START_TEXTCP="""
I'm CLASSPLUS Extractor bot....!

⤵️  Now, select the Option listed below. 🎯
"""
START_TEXTAPPX="""
I'm APPX Extractor bot....!

🔰  Now, select the Option listed below. 🎯
"""
START_TEXTCP1="""
I'm Going to Generate Auth Token....!

🎯  Now, select the Methods to Geneterate Classplus Auth Token. ✅
"""
HELP_TEXT="""
I'm Batch extractor bot...!
🚀Commands

/helper - For Extracting Txts.

⚠️ Save this id » @urban_rider2007 in case of Copyright infringement.
"""
